...
_binlibs(){
	...
	SHARESAVED="ff qt" # Enter here keywords or file/folder names to save in /usr/lib. By default, the names of the folders that you will save in /usr/share are selected also here.
...
_libkeywords(){
	LIBSAVED="alsa deepin ff jack qt pipewire pulse" # Enter here keywords or file/folder names to save in /usr/lib.
...
mv ./*AppImage ./Screen-Capture_"$VERSION""$VERSIONAUR"-archimage2.1-4-x86_64.AppImage
